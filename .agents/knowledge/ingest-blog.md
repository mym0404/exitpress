...
- Renderer, exporter, shared parser node types, UI, workflow, broad helpers, and unrelated knowledge stay out of the PR unless the focused failed HTML cannot fit existing contracts.
