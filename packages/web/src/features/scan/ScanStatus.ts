...
export const defaultCategoryStatus = "스캔 후 카테고리 선택 단계가 열립니다."
...
export const defaultScanLoadingStatus = "카테고리 스캔 중입니다."
export const forceScanLoadingStatus = "캐시를 비우고 카테고리를 다시 불러오고 있습니다."
