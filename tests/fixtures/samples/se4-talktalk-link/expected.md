...
저는 매월 **무료 강의**를 통해 **레벨업 오픈톡방 커뮤니티** 분들과 함께 배우고 성장하고 있습니다.

벌써 16번째 진행되는 특강으로 이번에도 업무와 SNS를 하시는 분들께 꼭 필요한 주제로 준비했습니다!

> **노션**

**🔸 좋다는데 쓰려니까 복잡해서 포기했어요.**

**🔸 고객정보, 일정, 매출까지 관리할 데이터가 너무 많은데 어디서부터 정리할지 막막해요.**

**🔸 메모장과 엑셀로만 정리하다가 중요한 정보들을 놓치고 있어요.**

사실, 많은 N잡러와 1인 사업자분들이 데이터를 효과적으로 관리하지 못해서 매일 업무가 쌓이고 시간도 낭비되고 있습니다.

**특히, 데이터가 체계적으로 관리되지 않으면 같은 작업을 반복하거나 중요한 업무를 놓치는 경우가 습니다.**

data 관리의 중요성이 더 커지고 있는 지금, Notion은 제대로만 쓰면 효율이 몇 배로 뛰어오르는 강력한 생산성 툴입니다. 🔥

이번 무료 특강에서는 노션의 첫 진입장벽을 확실히 없애드리고,**메모장이 아닌 체계적인 데이터 관리 툴로 바꾸는 방법을 알려드립니다.**

**실제로 지난 특강에 참여했던 분들도 이 툴을 적극 활용하면서 업무 시간을 크게 줄이고, 본업에 더 집중할 수 있게 되었다는 좋은 피드백을 많이 보내주셨어요.**
...
[궁금할 땐 네이버 톡톡하세요!](https://talk.naver.com/w42cwy?frm=mblog&ref=https%3A%2F%2Fm.blog.naver.com%2Fruangday%2F223790610732#nafullscreen)
