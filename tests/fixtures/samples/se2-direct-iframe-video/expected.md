...
우리 아이 사진, 가족사진, 소소한 일상이 담긴 사진들을

아름답고 우아하게 포스팅해보세요!

예전에 N드라이브에서 블로그 전용 앨범 뷰를 활용해 포스팅하는 방법을 알려드렸었는데요.

['카페/블로그 전용 앨범 뷰어'로 사진을 더 멋지게 올리기! >](http://blogpeople.blog.me/150167656676)

단조로운 내 블로그를 내가 찍은 사진들로 차곡차곡 채워보세요.

지나면 추억이 되고, 추억은 내 블로그를 반짝반짝 빛나게 한답니다.

\* 블로그 전용 앨범 뷰어로 올린 여행 사진입니다.

[Video](https://photocast.cloud.naver.com/inlineplayer/2;7C905E4C54EA4AFDC392C54901D1D68A;83295?blog&__authenticIframe=true)

**위와 같이 올리려면 어떻게 해야 하나요?**

\- N드라이브에서 좌측 사진 아이콘을 클릭한 후 블로그에 보낼 사진들을 선택하면 끝!
